 ...
 * @author vietan
 */
public class Table<C, M> {
    protected final int index;
    protected ArrayList<C> customers;
    protected M content;
    
    public Table(int index, M content){
        this.index = index;
    ...
    /** Remove a customer from this table. This should only be used through
     * the Restaurant object since this will change the total number of customers
