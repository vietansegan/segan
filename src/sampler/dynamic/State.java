 ...
 * 
 * Initially, the mean and variance of state t will be set to those of state (t-1)
 * 
 * After forward filtering, the mean and variance of state t is the parameters for
 * the Gaussian capturing the probability of state t given observation 1...t
 * P(s_t | x_1, x_2, ..., x_t)
 * 
