...
//                + ". storedLlh = " + storeDataLlh);
     ...
     * @param curNode The current node
     * @param empiricalLevelDistr The empirical level distribution of the current document
    ...
    /** Get an array containing all the regression parameters along a path.
     * The path is specified by a leaf node.
