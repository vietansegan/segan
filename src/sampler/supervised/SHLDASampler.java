...
/**
 * Gibbs sampler for Original SHLDA where each document is assigned to a path
 * in the topic tree.
 * 
 * @author vietan
 */
...
//        this.initializeModelStructure();
    ...
    private DirichletMultinomialModel[] docTopics;
    private int[][] x;
    ...
    private double[] regressNewDocumentsFlat(
        ...
        this.x = new int[D][];
        this.docTopics = new DirichletMultinomialModel[D];
        for(int d=0; d<D; d++){
            this.x[d] = new int[words[d].length];
            this.docTopics[d] = new DirichletMultinomialModel(nodeList.size(), 0.1 * nodeList.size(), 1.0 / nodeList.size());
        }
